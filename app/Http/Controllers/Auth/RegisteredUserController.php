        ...
        try {
           ...
           if(isset($request->formData))
           {
            ...
            if(isset($request->formData))
            {
                ...
                if(count($tokens)>0)
                {
                    FirebasePushNotification::sendNotification("New Lead near you!!!", "You have received new lead for ".$service->service_name, $tokens,"https://test.zbsburial.com/public/seller/dashboard");
                }
